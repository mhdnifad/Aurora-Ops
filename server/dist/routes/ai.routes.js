 ...
 * GET /api/ai/status
 */
router.get('/status', (0, helpers_1.asyncHandler)(async (_req, res) => {
    const status = {
        enabled: true,
        models: [
            {
 ...
 */
router.post('/suggestions', (0, helpers_1.asyncHandler)(async (req, res) => {
 ...
 */
router.post('/generate', (0, helpers_1.asyncHandler)(async (req, res) => {
