...
exports.getUserMembership = exports.tenantMiddleware = void 0;
...
const tenantMiddleware = async (req, _res, next) => {
    try {
        ...
        if (!organizationId) {
            ...
            if (!membership) {
                throw new errors_1.AuthorizationError('No active organization found. Please create or join an organization.');
            }
        ...
        if (!membership) {
            throw new errors_1.AuthorizationError('Access denied to this organization');
        }
 ...
 */
const getUserMembership = async (userId, organizationId) => {
    const membership = await Membership_1.default.findOne({
        userId,
        organizationId,
        status: 'active',
